    ...
    <section class="container">
        ...
        <table class="table table-hover">
            ...
            <% for (Municipio municipio : municipios) { %>
                <tr>
                    <th scope="row">                        
                        <a href="${pageContext.request.contextPath}/<%= urlDetalles %>&<%= MunicipioDAO.COLUMNA_ID %>=<%= municipio.getId() %>">
                            <%= municipio.getId() %>
                        </a>
                    </th>
                    ...
                    <td class="td-acciones">
                        <div class="hstack gap-3">
                            <a 
                                ...
                                href="${pageContext.request.contextPath}/<%= urlEditar %>&<%= MunicipioDAO.COLUMNA_ID %>=<%= municipio.getId() %>">
                                Editar
                            </a>
